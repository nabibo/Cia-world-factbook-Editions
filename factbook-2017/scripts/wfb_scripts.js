...
//		display1 = "display: none;";
		...
		display = "display: none;"
		image = '"../graphics/areacomparison/' + countrycode.toUpperCase() + '_area 2014.jpg" ';
		display = "";
		display1 = "display: none;";				
		description1 = flagdescription;
		addClass = 'mapFit1';
		hrefprint = '"../graphics/areacomparison/' + countrycode.toUpperCase() + '_area 2014.jpg" target= "blank"';
	}
