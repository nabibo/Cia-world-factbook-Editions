...
//		display1 = "display: none;";
		...
		image = '"../graphics/population/' + countrycode.toUpperCase() + '_popgraph 2015.bmp" class="populationFit"';
		display = "";
		display1 = "display: none;";
		...
		addClass = '';
		hrefprint = '"../graphics/population/' + countrycode.toUpperCase() + '_popgraph 2015.bmp" target="blank"';
	}
        ...
        else if (typeimage == 'religion')    {
                texttitle = '';
                display = "display: none;"
                image = '"../graphics/religion/' + 'middle-east-religion-graphic.jpg" ';
                display1 = "display: none;";
                description1 = '';
		addClass = '';
                hrefprint = '"../graphics/religion/' + 'middle-east-religion-graphic.pdf" target= "blank"';
        }
	else if (typeimage == 'fertility')	{
		texttitle = 'Total Fertility Rate';
		display = "display: none;"
		image = '"../graphics/fertility/' + countrycode.toUpperCase() + '_fertility 2014.bmp" ';
		display = "";
		display1 = "display: none;";				
		description1 = '';
		addClass = 'mapFit1';
		hrefprint = '"../graphics/fertility/' + countrycode.toUpperCase() + '_fertility 2014.bmp" target= "blank"';
	}
	else if (typeimage == 'areacomparison')	{
		texttitle = 'Area Comparison';
		display = "display: none;"
		image = '"../graphics/areacomparison/' + countrycode.toUpperCase() + '_area.jpg" ';
		display = "";
		display1 = "display: none;";				
		description1 = flagdescription;
		addClass = 'mapFit1';
		hrefprint = '"../graphics/areacomparison/' + countrycode.toUpperCase() + '_area.jpg" target= "blank"';
	}
